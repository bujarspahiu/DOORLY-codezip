    ...
    <div className="min-h-screen bg-gray-900 flex">
      ...
      <aside className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-gray-800 border-r border-gray-700 transform transition-transform duration-200 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
        <div className="flex flex-col h-full">
          <div className="px-6 py-5 border-b border-gray-700"><div className="flex items-center gap-2"><img src="/doorly-logo-nobg.png" alt="Doorly" className="h-9" /><div><span className="text-lg font-bold text-white">Admin</span><p className="text-xs text-gray-400">Super Administrator</p></div></div></div>
